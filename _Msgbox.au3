...
Global Const $_MB_CANCEL_TEXT = 'Cancel'
...
; #FUNCTION# ====================================================================================================================
; Name ..........: _MsgBox
; Description ...: Create a beautiful notification board, flat design style and mix metro ui
; Syntax ........: _MsgBox($flag, $title, $text [, $timeout = 0])
; Parameters ....: $flag - Like msgbox, but does not accept Modality-related and Miscellaneous-related (Except topmost attribute: 262144)
; $title - window title
; $text - notification board content
; $timeout - [optional] timeout in seconds. Default is 0.
; Return values ​​.: like Msgbox
